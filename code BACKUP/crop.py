...
def setup(path,name):
    ...
    # pygame.display.set_caption('DDSPL')
    # font = pygame.font.SysFont(None, 35)
    fontObj = pygame.font.SysFont('Lohit Devanagari', 22)
    # font=pygame.font.Font(None, 32)
    print(name)
    text =fontObj.render(name, True,"blue", "green")
    ...
    screen.blit(px,(px.get_rect()))
    pygame.display.flip()
    screen.blit(text,(710,2))
    # screen.fill(10)
    pygame.display.update()
  
    return screen,px,text

def mainLoop(screen,px,count,text):
...
if __name__ == "__main__":
    ...
    while True: 
        ...
        left, upper, right, lower,index,w = mainLoop(screen, px,count,text)
